...
zarrs_data_type::codec_traits::impl_pcodec_data_type_traits!(NumpyTimeDelta64DataType, I64, 1);
zarrs_data_type::codec_traits::impl_bitround_codec!(NumpyTimeDelta64DataType, 8, int64);
zarrs_data_type::codec_traits::impl_zfp_data_type_traits!(NumpyTimeDelta64DataType, Int64);
