...
crate::impl_bitround_codec!(Int8DataType, 1, int8);
#[cfg(feature = "bitround")]
crate::impl_bitround_codec!(Int16DataType, 2, int16);
#[cfg(feature = "bitround")]
crate::impl_bitround_codec!(Int32DataType, 4, int32);
#[cfg(feature = "bitround")]
crate::impl_bitround_codec!(Int64DataType, 8, int64);

// Pcodec implementations for standard integers (int8 not supported)
#[cfg(feature = "pcodec")]
crate::impl_pcodec_codec!(Int16DataType, I16, 1);
#[cfg(feature = "pcodec")]
crate::impl_pcodec_codec!(Int32DataType, I32, 1);
#[cfg(feature = "pcodec")]
crate::impl_pcodec_codec!(Int64DataType, I64, 1);

// FixedScaleOffset implementations for standard integers
crate::impl_fixedscaleoffset_codec!(Int8DataType, I8);
crate::impl_fixedscaleoffset_codec!(Int16DataType, I16);
crate::impl_fixedscaleoffset_codec!(Int32DataType, I32);
crate::impl_fixedscaleoffset_codec!(Int64DataType, I64);

// ZFP implementations for standard integers
#[cfg(feature = "zfp")]
crate::impl_zfp_codec!(Int8DataType, Int32, I8ToI32);
#[cfg(feature = "zfp")]
crate::impl_zfp_codec!(Int16DataType, Int32, I16ToI32);
#[cfg(feature = "zfp")]
crate::impl_zfp_codec!(Int32DataType, Int32);
#[cfg(feature = "zfp")]
crate::impl_zfp_codec!(Int64DataType, Int64);

// PackBits implementations for standard integers
crate::impl_packbits_codec!(Int8DataType, 8, signed, 1);
crate::impl_packbits_codec!(Int16DataType, 16, signed, 1);
crate::impl_packbits_codec!(Int32DataType, 32, signed, 1);
crate::impl_packbits_codec!(Int64DataType, 64, signed, 1);
