...
mod tests {
    ...
    fn codec_bitround_float() {
        ...
        let elements: Vec<f32> = vec![
            ...
            // -8.0       -> 110000010000
            -8.358_719,
            // 98765.43   -> 010001111100|00001110011010110111
    ...
    fn codec_bitround_uint() {
        ...
        let elements: Vec<u32> = vec![0, 1024, 1280, 1664, 1685, 123_145_182, 4_294_967_295];
        let bytes = crate::array::transmute_to_bytes_vec(elements);
        let bytes = ArrayBytes::from(bytes);
        ...
        assert_eq!(
            decoded_elements,
            &[0, 1024, 1280, 1536, 1792, 117_440_512, 3_758_096_384]
        );
    }
