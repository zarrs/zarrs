...
impl ShardingPartialEncoder {
    ...
    pub(crate) fn new(
        ...
        let chunk_grid = RegularChunkGrid::new(shard_shape.clone(), subchunk_shape.clone())
...
impl ArrayPartialDecoderTraits for ShardingPartialEncoder {
    ...
    fn local_subchunk_grids(
        ...
        let subchunk_grid = ChunkGrid::new(
            RegularBoundedChunkGrid::new(self.shard_shape.clone(), self.subchunk_shape.clone())
