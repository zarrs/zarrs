...
- **Breaking**: Bump public dependencies: `zarrs_metadata` 0.7.0, `zarrs_data_type` 0.8.1, `zarrs_metadata_ext` 0.4.0, `zarrs_plugin` 0.4.0, `float8` 0.5.0, `dlpark` 0.6.0, `ndarray` 0.17.1
